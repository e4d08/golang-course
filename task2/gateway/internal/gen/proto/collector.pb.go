...
type GetRepositoryResponse struct {
	...
	StarsCount    uint32                 `protobuf:"varint,3,opt,name=stars_count,json=starsCount,proto3" json:"stars_count,omitempty"`
	ForksCount    uint32                 `protobuf:"varint,4,opt,name=forks_count,json=forksCount,proto3" json:"forks_count,omitempty"`
...
func (x *GetRepositoryResponse) GetStarsCount() uint32 {
	if x != nil {
		return x.StarsCount
	}
	return 0
...
func (x *GetRepositoryResponse) GetForksCount() uint32 {
	if x != nil {
		return x.ForksCount
	}
	return 0
...
func (x *GetRepositoryResponse) GetLicense() string {
	if x != nil {
		return x.License
	}
	return ""
...
const file_collector_proto_rawDesc = "" +
	"\n" +
	"\x0fcollector.proto\x12\tcollector\x1a\x1fgoogle/protobuf/timestamp.proto\"@\n" +
	...
	"\vstars_count\x18\x03 \x01(\rR\n" +
	"starsCount\x12\x1f\n" +
	"\vforks_count\x18\x04 \x01(\rR\n" +
	"forksCount\x129\n" +
	"\n" +
	"created_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x12\x18\n" +
	"\alicense\x18\x06 \x01(\tR\alicense2f\n" +
	"\x10CollectorService\x12R\n" +
	"\rGetRepository\x12\x1f.collector.GetRepositoryRequest\x1a .collector.GetRepositoryResponseB.Z,internal/common/genproto/collector;collectorb\x06proto3"
